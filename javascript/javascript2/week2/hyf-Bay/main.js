...
//     const machingProducts = products.filter(product => product.name.toLowerCase().includes(value.toLowerCase()));
//     renderProducts(machingProducts);
// });
// select.addEventListener('change',()=>{
//     const value=select.value;
//     const machingCountries=products.filter(country=>country.shipsTo.map(country=>country.toLowerCase()).includes(value.toLowerCase()));
// renderProducts(machingCountries);
//     });
